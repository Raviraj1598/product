...
export default function Cart() {
  ...
  const { tax, shipping, total } = checkoutTotals({
    settings,
    subtotal,
        ...
        <div>
          <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-24">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">Tax ({settings.taxPercent}%)</span>
              ...
              {subtotal > 0 && subtotal < settings.freeShippingMin && (
                <p className="text-sm text-gray-500">
                  Add ${(settings.freeShippingMin - subtotal).toFixed(2)} more for free shipping!
                </p>
              )}
            </div>
